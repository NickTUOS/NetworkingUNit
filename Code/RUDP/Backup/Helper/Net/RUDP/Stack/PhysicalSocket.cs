...
namespace Helper.Net.RUDP
{
	...
	sealed internal class PhysicalSocket
	{
		...
		internal PhysicalSocket()
		{
			...
			_socket.SendBufferSize = 100 * 1024;
			_socket.ReceiveBufferSize = 100 * 1024;

			/*
			_socket.SetSocketOption(SocketOptionLevel.Socket, SocketOptionName.Debug, false);
		...
		internal RUDPSocket OnEndAccept(IPEndPoint remoteEndPoint, int packetId)
		{
			...
			acceptSocket._connectionId = RUDPSocket.GenerateUniqueId();
